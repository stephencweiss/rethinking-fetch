...
This is definitely a functional programming paradigm.<sup>1</sup>
<Footnote>

Jim R gave a talk, <a href="https://drive.google.com/file/d/1xr7utDf_XRmcXvwnMWrOrNlEN23OVwul/view?usp=sharing">Functions are Interfaces</a> about functional programming, and we have the <a href="https://ololabs.atlassian.net/wiki/spaces/OLO/pages/328434498/Learning+F">Learning F#</a> space for more resources on functional approaches.
